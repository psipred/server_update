...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\nBLASTUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\nBLASTUPDATE-OK"}' https://hooks.slack.com/services/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
