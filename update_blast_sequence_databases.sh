...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\n'`uname -n`' BLASTUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\n'`uname -n`' BLASTUPDATE-OK"}' https://hooks.slack.com/services/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
