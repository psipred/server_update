...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\n'`uname -n`' SEQUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
celery multi stop_verify worker --pidfile=/home/blast_worker/analytics_automated/celery.pid --logfile=/home/blast_worker/analytics_automated/logs/
...
ssh blast_worker@bm1 "source /home/blast_worker/aa_env/bin/activate; celery multi stop_verify worker --pidfile=/home/django_worker/analytics_automated/celery.pid --logfile=/home/django_worker/analytics_automated/logs/"
scp /data/update_tmp/pdbaa* blast_worker@bm1:/data/pdbaa/
scp /data/update_tmp/uniref* blast_worker@bm1:/data/uniref/
rm -f pdb70_from_mmcif_latest.tar.gz
scp -r /data/update_tmp/pdb70* blast_worker@bm1:/data/hhdb/pdb/
scp /data/update_tmp/pdb_filter.dat blast_worker@bm1:/data/hhdb/pdb/
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\n'`uname -n`' SEQUPDATE-OK"}' https://hooks.slack.com/services/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
