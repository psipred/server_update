...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\n'`uname -n`' SEQUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\n'`uname -n`' SEQUPDATE-OK"}' https://hooks.slack.com/services/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
