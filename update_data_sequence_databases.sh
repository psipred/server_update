...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\nSEQUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\nSEQUPDATE-OK"}' https://hooks.slack.com/services/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
