...
err_report() {
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":":rage:\n'`uname -n`' PDBUPDATE-FAILED"}' https://hooks.slack.com/services/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
  exit 0
}
trap err_report ERR
...
curl -X POST -H 'Content-type: application/json' --data '{"text":":smile:\n'`uname -n`' PDBUPDATE-OK"}' https://hooks.slack.com/services/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
